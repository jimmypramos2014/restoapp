...
if ($_POST){
    if ($_POST['btnGuardar']){
        ...
        $NroDNI = isset($_POST['txtNroDoc']) ? $_POST['txtNroDoc'] : '';
                    ...
                    <div class="grid">
                        <div class="row">
                            ...
                            <div class="span6">
                                <ul id="nav">
                                    <li>
                                        <a href="#" data-tipocliente="01"><?php $translate->__('Cliente natural'); ?></a>
                                        <section>
                                            <div class="grid">
                                                <div class="row">
                                                    <label for="txtNroDoc">Nro Doc</label>
                                                    <div class="input-control text" data-role="input-control">
                                                        <input id="txtNroDoc" name="txtNroDoc" type="text" placeholder="<?php $translate->__('Ejemplo: 45035046'); ?>">
                                    ...
                                    <li>
                                        <a href="#" data-tipocliente="00"><?php $translate->__('Cliente jur&iacute;dico'); ?></a>
                                        <section>
...
<div id="modalUpload" class="modal-example-content">
    <div class="modal-example-header">
        <a class="close" href="#" onclick="$.fn.custombox('close');">&times;</a>
    ...
    <div class="modal-example-body">
        ...
        <div id="area2" class="span3">
            <input id="fileData" type="file" class="droparea spot" name="xfile" data-tipoupload="clientes" data-post="upload-data.php" data-height="235" data-crop="false"/>
        </div>
    </div>
</div>
<?php
...
<script>
    ...
    $(function () {
        ...
        $('#nav').on('click', 'li > a', function() {
            if (!$(this).parent().hasClass('active')) {
                ...
                $(this).next().toggleClass('is-open').toggle(300, function () {
                    //ShowDataByCurrentTab();
                });
                ...
                $('#hdTipoCliente').val($(this).attr('data-tipocliente'));
            }
            else {
                $('#nav .is-open').removeClass('is-open').hide(300);
        ...
        /*$('#fileuploader').uploadFile({
            ...
            onSuccess:function(files,data,xhr){
                MessageBox('Importación exitosa', 'La operación se completó correctamente.', "[Aceptar]", function () {
                    $('#hdPage').val('1');
                    $('#hdPageActual').val('1');
                });
            }
        ...
        $('.userFoto').droparea({
            ...
            'complete' : function(result, file, input, area){
                MessageBox('<?php $translate->__('Importaci&oacute;n exitosa'); ?>', '<?php $translate->__('La operaci&oacute;n se complet&oacute; correctamente.'); ?>', "[<?php $translate->__('Aceptar'); ?>]", function () {
                    $('#hdPage').val('1');
                    $('#hdPageActual').val('1');
                });
                ...
                if (itemSelected.length > 0){
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $('#txtNroDoc').val(datos[0].tm_nrodni);
    ...
    function BuscarDatos (pagina) {
        LoadClientes(TipoBusqueda, $('#txtSearch').val(), '', pagina);
    }

    function BackToList () {
        removeValidFormRegister();
        $('#pnlForm').fadeOut(500, function () {
            $('#btnNuevo, #btnReporte').removeClass('oculto');
